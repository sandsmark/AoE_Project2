...
CutsceneElement::CutsceneElement(elements_groups group, const char *path, const char *name, bool active) :
    group(group), path(path), active(active), name(name)
{
...
CutsceneMap::CutsceneMap(elements_groups group, const char *path, const char *name, bool active) :
...
CutsceneUnit::CutsceneUnit(elements_groups group, const char *path, const char *name, unitType type, bool active, iPoint pos) :
    CutsceneElement(group, path, name, active)
{
...
CutsceneBuilding::CutsceneBuilding(elements_groups group, const char *path, const char *name, buildingType type, bool active, iPoint pos) :
    CutsceneElement(group, path, name, active)
{
...
CutsceneMusic::CutsceneMusic(elements_groups group, const char *path, const char *name, bool active) :
    CutsceneElement(group, path, name, active)
{
    if (active) {
...
CutsceneSoundEffect::CutsceneSoundEffect(elements_groups group, const char *path, const char *name, bool active, int loops) :
    CutsceneElement(group, path, name, active), loops(loops)
{
...
CutsceneAction::CutsceneAction(actions action, const char *name, int start_time, int duration) :
    action(action), element_name(name), start(start_time), duration(duration)
{
}

CutsceneMove::CutsceneMove(actions action, const char *name, int start_time, int duration) :
    CutsceneAction(action, name, start_time, duration)
{
}
...
CutsceneModifyUnit::CutsceneModifyUnit(actions action, const char *name, int start_time, int duration) :
    CutsceneAction(action, name, start_time, duration)
{
}

CutsceneModifyImage::CutsceneModifyImage(actions action, const char *name, int start_time, int duration) :
    CutsceneAction(action, name, start_time, duration)
{
}

CutsceneModifyText::CutsceneModifyText(actions action, const char *name, int start_time, int duration) :
    CutsceneAction(action, name, start_time, duration)
{
}

CutsceneChangeScene::CutsceneChangeScene(actions action, const char *name, int start_time, int duration) :
    CutsceneAction(action, name, start_time, duration)
{
}
...
CutsceneModifyCamera::CutsceneModifyCamera(actions action, const char *name, int start_time, int duration) :
    CutsceneAction(action, name, start_time, duration)
{
}
