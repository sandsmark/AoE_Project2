...
private:
    ...
    Image *single = nullptr;
    Label *name = nullptr;
    Label *armor_val = nullptr;
    Label *damage_val = nullptr;
    Label *life = nullptr;

    Image *sword_img = nullptr;
    Image *armor_img = nullptr;
    uint id;
...
private:
    ...
    enum HUDBuildingState { BUILDINGNULL,
                            BUILDINGMENU,
                            BUILDINGCREATEUNITS,
                            BUILDINGCREATEHERO };
...
public:
    UnitSprite(EntityType argtype, SDL_Rect argrectangle, uint argID, string argname) :
        type(argtype), rectangle(argrectangle), ID(argID), name(argname)
    {
    }
    SDL_Rect GetRect()
    {
