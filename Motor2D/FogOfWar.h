...
enum fow_id {
    ...
    fow_grey_rdown,
    fow_grey_rleft,
    fow_grey_rright, // Filled with black edge
    ...
    fow_black_rdown,
    fow_black_rleft,
    fow_black_rright, // Grey rounded with black edge
    fow_clear_rectupright,
    fow_clear_rectupleft,
    fow_clear_rectdownright,
    fow_clear_rectdownleft,
    fow_clear_sup,
    fow_clear_sdown,
    fow_clear_sleft,
    fow_clear_sright
